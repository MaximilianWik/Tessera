...
<p align="center">
  <img src="hagia_sophia_tessera.jpg" alt="Detail of the Imperial Gate Mosaic in Hagia Sophia (circa 886-912 CE), showing how the image is built from thousands of small stone and gold-leaf tesserae." width="640">
  <br>
  <em>Detail from the Imperial Gate Mosaic, Hagia Sophia, circa 886-912 CE. Each tile is a tessera; the picture is still there, eleven hundred years later, because every one of them is.</em>
</p>
...
3. Click Deploy. First deploy takes around 30 seconds.
